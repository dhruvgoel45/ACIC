        ...
        <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-xl lg:max-w-screen-xl md:px-0 lg:px-0">
          <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
            <div className="sm:col-span-2">
              ...
              >
                <span className=" text-xl font-poppins font-bold tracking-wide text-2xl text-white uppercase">
                  ACIC BMU Foundation
                </span>
              </a>
              <div className="mt-6 lg:max-w-sm">
                <img src="https://www.bmu.edu.in/acic-propel/images/logo01.png" />
              </div>
            </div>
            <div className="space-y-2 text-sm">
              ...
              <div className="flex">
                ...
                <a
                  href="https://goo.gl/maps/DVHeCfiqki9j9qhj7"
                  target="_blank"
                  ...
                  className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800"
                >
                  ACIC-BMU Foundation,BML Munjal University
                  ,Kapriwas,Haryana,India
                </a>
              </div>
            </div>
            <div>
              ...
              <div className="flex items-center mt-1 space-x-3">
                ...
                >
                  <svg viewBox="0 0 24 24" fill="currentColor" className="h-10">
                ...
                <a
                  ...
                  className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400"
                >
                  <svg viewBox="0 0 30 30" fill="currentColor" className="h-10">
